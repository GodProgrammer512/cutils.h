...
// Math variables:
	...
	#define PI_M_L 3.1415926535897932385L                                // Pi (medium type in long double).
	#define PI_L_L 3.14159265358979323846264338327950288419716939937510L // Pi (Long type in long double. Not recommended for PRECISE CALCULATIONS!!!).
#endif
